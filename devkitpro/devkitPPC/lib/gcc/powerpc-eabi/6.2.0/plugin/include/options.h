...
#ifndef GENERATOR_FILE
  int x_VAR_mgcbios;
#define x_VAR_mgcbios do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mgcn;
#define x_VAR_mgcn do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mmvme;
...
#ifndef GENERATOR_FILE
  int x_VAR_mvgc;
#define x_VAR_mvgc do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mwup;
#define x_VAR_mwup do_not_use
#endif
#ifndef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_Wpragmas = 349,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 350,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 351,                       /* -Wprotocol */
  OPT_Wpsabi = 352,                          /* -Wpsabi */
  OPT_Wraw = 353,                            /* -Wraw */
  OPT_Wreal_q_constant = 354,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 355,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 356,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 357,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 358,            /* -Wredundant-modifiers */
  OPT_Wreorder = 359,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 360,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 361,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 362,           /* -Wscalar-storage-order */
  OPT_Wselector = 363,                       /* -Wselector */
  OPT_Wsequence_point = 364,                 /* -Wsequence-point */
  OPT_Wserial = 365,                         /* -Wserial */
  OPT_Wshadow = 366,                         /* -Wshadow */
  OPT_Wshadow_ivar = 367,                    /* -Wshadow-ivar */
  OPT_Wshift_count_negative = 368,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 369,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 370,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 371, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 372,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 373,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 374,                /* -Wsign-conversion */
  OPT_Wsign_promo = 375,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 376,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 377,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_memaccess = 378,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 379,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 380,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 381,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 382,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 383,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 384,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 385,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 386,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 387,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 388,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 389,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 390,          /* -Wstrict-selector-match */
  OPT_Wsubobject_linkage = 391,              /* -Wsubobject-linkage */
  ...
  OPT_Wsynthetic_access = 407,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 408,                 /* -Wsystem-headers */
  OPT_Wtabs = 409,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 410,                /* -Wtarget-lifetime */
  OPT_Wtasks = 411,                          /* -Wtasks */
  OPT_Wtautological_compare = 412,           /* -Wtautological-compare */
  OPT_Wtemplates = 413,                      /* -Wtemplates */
  OPT_Wterminate = 414,                      /* -Wterminate */
  OPT_Wtraditional = 415,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 416,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 417,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 418,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 419,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 420,                    /* -Wtype-limits */
  OPT_Wuncheck = 421,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 422,            /* -Wundeclared-selector */
  OPT_Wundef = 423,                          /* -Wundef */
  OPT_Wunderflow = 424,                      /* -Wunderflow */
  OPT_Wuninitialized = 425,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 426,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 427,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 428,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 429, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 430,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 431,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 432,                         /* -Wunused */
  OPT_Wunused_argument = 433,                /* -Wunused-argument */
  ...
  OPT_Wunused_import = 440,                  /* -Wunused-import */
  OPT_Wunused_label = 441,                   /* -Wunused-label */
  OPT_Wunused_local = 442,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 443,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 444,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 445,               /* -Wunused-parameter */
  OPT_Wunused_private = 446,                 /* -Wunused-private */
  OPT_Wunused_result = 447,                  /* -Wunused-result */
  OPT_Wunused_thrown = 448,                  /* -Wunused-thrown */
  OPT_Wunused_value = 449,                   /* -Wunused-value */
  OPT_Wunused_variable = 450,                /* -Wunused-variable */
  OPT_Wuse_without_only = 451,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 452,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 453,             /* -Wuseless-type-check */
  OPT_Wvarargs = 454,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 455,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 456,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 457,   /* -Wvector-operation-performance */
  OPT_Wvirtual_inheritance = 458,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 459,            /* -Wvirtual-move-assign */
  OPT_Wvla = 460,                            /* -Wvla */
  OPT_Wvolatile_register_var = 461,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 462,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 463,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 464,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 465,                       /* -Wzerotrip */
  OPT_Xassembler = 466,                      /* -Xassembler */
  OPT_Xlinker = 467,                         /* -Xlinker */
  OPT_Xpreprocessor = 468,                   /* -Xpreprocessor */
  OPT_Z = 469,                               /* -Z */
  OPT_ansi = 470,                            /* -ansi */
  OPT_aux_info = 471,                        /* -aux-info */
  /* OPT_aux_info_ = 472, */                 /* -aux-info= */
  OPT_auxbase = 473,                         /* -auxbase */
  OPT_auxbase_strip = 474,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 475, */             /* -bootclasspath */
  OPT_c = 476,                               /* -c */
  /* OPT_classpath = 477, */                 /* -classpath */
  OPT_coverage = 478,                        /* -coverage */
  OPT_cpp = 479,                             /* -cpp */
  OPT_cpp_ = 480,                            /* -cpp= */
  OPT_d = 481,                               /* -d */
  OPT_dumpbase = 482,                        /* -dumpbase */
  OPT_dumpdir = 483,                         /* -dumpdir */
  OPT_dumpmachine = 484,                     /* -dumpmachine */
  OPT_dumpspecs = 485,                       /* -dumpspecs */
  OPT_dumpversion = 486,                     /* -dumpversion */
  OPT_e = 487,                               /* -e */
  /* OPT_encoding = 488, */                  /* -encoding */
  OPT_export_dynamic = 489,                  /* -export-dynamic */
  OPT_extdirs = 490,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 491, */               /* -fCLASSPATH= */
  OPT_fPIC = 492,                            /* -fPIC */
  OPT_fPIE = 493,                            /* -fPIE */
  OPT_fRTS_ = 494,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 495,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 496,                   /* -fabi-version= */
  OPT_faccess_control = 497,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 498,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 499,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 500,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 501,                  /* -falign-commons */
  OPT_falign_functions = 502,                /* -falign-functions */
  OPT_falign_functions_ = 503,               /* -falign-functions= */
  OPT_falign_jumps = 504,                    /* -falign-jumps */
  OPT_falign_jumps_ = 505,                   /* -falign-jumps= */
  OPT_falign_labels = 506,                   /* -falign-labels */
  OPT_falign_labels_ = 507,                  /* -falign-labels= */
  OPT_falign_loops = 508,                    /* -falign-loops */
  OPT_falign_loops_ = 509,                   /* -falign-loops= */
  OPT_fall_intrinsics = 510,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 511, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 512,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 513,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 514, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 515, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 516, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 517, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 518, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 519,            /* -fasan-shadow-offset= */
  OPT_fasm = 520,                            /* -fasm */
  OPT_fassert = 521,                         /* -fassert */
  OPT_fassociative_math = 522,               /* -fassociative-math */
  OPT_fassume_compiled = 523,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 524,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 525,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 526,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 527,                   /* -fauto-profile */
  OPT_fauto_profile_ = 528,                  /* -fauto-profile= */
  OPT_fautomatic = 529,                      /* -fautomatic */
  OPT_faux_classpath = 530,                  /* -faux-classpath */
  OPT_fbackslash = 531,                      /* -fbackslash */
  OPT_fbacktrace = 532,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 533,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 534,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 535,              /* -fbootstrap-classes */
  OPT_fbounds_check = 536,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 537,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 538,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 539,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 540,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 541,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 542,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 543,                        /* -fbuiltin */
  OPT_fbuiltin_ = 544,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 545,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 546,                    /* -fcall-saved- */
  OPT_fcall_used_ = 547,                     /* -fcall-used- */
  OPT_fcaller_saves = 548,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 549,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 550,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 551,                /* -fcheck-data-deps */
  OPT_fcheck_new = 552,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 553,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 554,               /* -fcheck-references */
  OPT_fcheck_ = 555,                         /* -fcheck= */
  OPT_fchecking = 556,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 557,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 558,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 559,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 560,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 561,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 562,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 563,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 564, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 565,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 566,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 567,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 568, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 569,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 570,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 571,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 572,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 573,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 574,                       /* -fcilkplus */
  OPT_fclasspath_ = 575,                     /* -fclasspath= */
  OPT_fcoarray_ = 576,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 577,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 578,                         /* -fcommon */
  OPT_fcompare_debug = 579,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 580,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 581,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 582,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 583,              /* -fcompile-resource= */
  OPT_fconcepts = 584,                       /* -fconcepts */
  OPT_fcond_mismatch = 585,                  /* -fcond-mismatch */
  OPT_fconserve_space = 586,                 /* -fconserve-space */
  OPT_fconserve_stack = 587,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 588,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 589,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 590,                       /* -fconvert= */
  OPT_fcprop_registers = 591,                /* -fcprop-registers */
  OPT_fcray_pointer = 592,                   /* -fcray-pointer */
  OPT_fcrossjumping = 593,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 594,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 595, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 596,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 597,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 598,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 599,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 600,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 601,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 602,                       /* -fdbg-cnt= */
  OPT_fdce = 603,                            /* -fdce */
  OPT_fdebug_cpp = 604,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 605,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 606,            /* -fdebug-types-section */
  OPT_fdec = 607,                            /* -fdec */
  OPT_fdec_structure = 608,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 609,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 610,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 611,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 612, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 613,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 614,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 615,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 616,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 617,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 618,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 619,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 620,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 621,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 622, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 623,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 624,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 625,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 626,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 627,                /* -fdirectives-only */
  OPT_fdisable_ = 628,                       /* -fdisable- */
  OPT_fdisable_assertions = 629,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 630,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 631,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 632,         /* -fdollars-in-identifiers */
  OPT_fdse = 633,                            /* -fdse */
  OPT_fdump_ = 634,                          /* -fdump- */
  OPT_fdump_ada_spec = 635,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 636,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 637, */                /* -fdump-core */
  OPT_fdump_final_insns = 638,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 639,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 640,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 641,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 642,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 643,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 644,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 645, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 646,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 647,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 648,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 649,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 650,                 /* -fearly-inlining */
  OPT_felide_constructors = 651,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 652,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 653, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 654,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 655,        /* -femit-class-debug-always */
  OPT_femit_class_file = 656,                /* -femit-class-file */
  OPT_femit_class_files = 657,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 658,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 659,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 660,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 661,                        /* -fenable- */
  OPT_fenable_assertions = 662,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 663,             /* -fenable-assertions= */
  OPT_fencoding_ = 664,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 665,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 666, */           /* -fenum-int-equiv */
  OPT_fexceptions = 667,                     /* -fexceptions */
  OPT_fexcess_precision_ = 668,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 669,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 670,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 671,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 672,                       /* -fextdirs= */
  OPT_fextended_identifiers = 673,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 674,                /* -fextern-tls-init */
  OPT_fexternal_blas = 675,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 676, */       /* -fexternal-templates */
  OPT_ff2c = 677,                            /* -ff2c */
  OPT_ffast_math = 678,                      /* -ffast-math */
  OPT_ffat_lto_objects = 679,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 680,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 681,               /* -ffinite-math-only */
  OPT_ffixed_ = 682,                         /* -ffixed- */
  OPT_ffixed_form = 683,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 684,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 685,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 686,                    /* -ffloat-store */
  OPT_ffor_scope = 687,                      /* -ffor-scope */
  /* OPT_fforce_addr = 688, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 689,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 690,              /* -fforward-propagate */
  OPT_ffp_contract_ = 691,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 692,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 693,                      /* -ffpe-trap= */
  OPT_ffree_form = 694,                      /* -ffree-form */
  OPT_ffree_line_length_ = 695,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 696,          /* -ffree-line-length-none */
  OPT_ffreestanding = 697,                   /* -ffreestanding */
  OPT_ffriend_injection = 698,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 699,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 700,                   /* -ffunction-cse */
  OPT_ffunction_sections = 701,              /* -ffunction-sections */
  OPT_fgcse = 702,                           /* -fgcse */
  OPT_fgcse_after_reload = 703,              /* -fgcse-after-reload */
  OPT_fgcse_las = 704,                       /* -fgcse-las */
  OPT_fgcse_lm = 705,                        /* -fgcse-lm */
  OPT_fgcse_sm = 706,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 707,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 708,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 709,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 710,                         /* -fgnu-tm */
  OPT_fgnu_unique = 711,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 712,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 713,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 714,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 715,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 716,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 717,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 718,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 719,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 720,                       /* -fgraphite */
  OPT_fgraphite_identity = 721,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 722,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 723, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 724, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 725,           /* -fhash-synchronization */
  /* OPT_fhelp = 726, */                     /* -fhelp */
  /* OPT_fhelp_ = 727, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 728,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 729, */                /* -fhonor-std */
  OPT_fhosted = 730,                         /* -fhosted */
  /* OPT_fhuge_objects = 731, */             /* -fhuge-objects */
  OPT_fident = 732,                          /* -fident */
  OPT_fif_conversion = 733,                  /* -fif-conversion */
  OPT_fif_conversion2 = 734,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 735,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 736,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 737,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 738,             /* -fimplicit-templates */
  OPT_findirect_classes = 739,               /* -findirect-classes */
  OPT_findirect_dispatch = 740,              /* -findirect-dispatch */
  OPT_findirect_inlining = 741,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 742,         /* -finhibit-size-directive */
  OPT_finit_character_ = 743,                /* -finit-character= */
  OPT_finit_integer_ = 744,                  /* -finit-integer= */
  OPT_finit_local_zero = 745,                /* -finit-local-zero */
  OPT_finit_logical_ = 746,                  /* -finit-logical= */
  OPT_finit_real_ = 747,                     /* -finit-real= */
  OPT_finline = 748,                         /* -finline */
  OPT_finline_atomics = 749,                 /* -finline-atomics */
  OPT_finline_functions = 750,               /* -finline-functions */
  OPT_finline_functions_called_once = 751,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 752, */            /* -finline-limit- */
  OPT_finline_limit_ = 753,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 754,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 755,         /* -finline-small-functions */
  OPT_finput_charset_ = 756,                 /* -finput-charset= */
  OPT_finstrument_functions = 757,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 758,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 759,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 760,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 761,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 762,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 763,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 764,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 765,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 766,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 767,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 768,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 769, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 770,                    /* -fipa-profile */
  OPT_fipa_pta = 771,                        /* -fipa-pta */
  OPT_fipa_pure_const = 772,                 /* -fipa-pure-const */
  OPT_fipa_ra = 773,                         /* -fipa-ra */
  OPT_fipa_reference = 774,                  /* -fipa-reference */
  OPT_fipa_sra = 775,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 776, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 777,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 778,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 779,              /* -fira-loop-pressure */
  OPT_fira_region_ = 780,                    /* -fira-region= */
  OPT_fira_share_save_slots = 781,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 782,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 783,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 784,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 785,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 786,               /* -fivar-visibility= */
  OPT_fivopts = 787,                         /* -fivopts */
  OPT_fjni = 788,                            /* -fjni */
  OPT_fjump_tables = 789,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 790,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 791,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 792,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 793,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 794,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 795, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 796,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 797,             /* -fleading-underscore */
  OPT_flifetime_dse = 798,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 799,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 800,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 801,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 802,                    /* -flocal-ivars */
  /* OPT_floop_block = 803, */               /* -floop-block */
  /* OPT_floop_flatten = 804, */             /* -floop-flatten */
  /* OPT_floop_interchange = 805, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 806,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 807, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 808,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 809, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 810, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 811,                      /* -flra-remat */
  OPT_flto = 812,                            /* -flto */
  OPT_flto_compression_level_ = 813,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 814,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 815,                 /* -flto-partition= */
  OPT_flto_report = 816,                     /* -flto-report */
  OPT_flto_report_wpa = 817,                 /* -flto-report-wpa */
  OPT_flto_ = 818,                           /* -flto= */
  OPT_fltrans = 819,                         /* -fltrans */
  OPT_fltrans_output_list_ = 820,            /* -fltrans-output-list= */
  OPT_fmain_ = 821,                          /* -fmain= */
  OPT_fmath_errno = 822,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 823,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 824,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 825,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 826,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 827,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 828,                     /* -fmem-report */
  OPT_fmem_report_wpa = 829,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 830,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 831,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 832,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 833,                /* -fmessage-length= */
  OPT_fmodule_private = 834,                 /* -fmodule-private */
  OPT_fmodulo_sched = 835,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 836,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 837,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 838,                  /* -fms-extensions */
  /* OPT_fmudflap = 839, */                  /* -fmudflap */
  /* OPT_fmudflapir = 840, */                /* -fmudflapir */
  /* OPT_fmudflapth = 841, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 842, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 843, */                  /* -fnew-abi */
  OPT_fnext_runtime = 844,                   /* -fnext-runtime */
  OPT_fnil_receivers = 845,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 846, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 847,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 848,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 849, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 850,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 851,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 852,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 853,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 854,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 855,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 856,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 857,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 858,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 859,                   /* -foffload-abi= */
  OPT_foffload_ = 860,                       /* -foffload= */
  OPT_fomit_frame_pointer = 861,             /* -fomit-frame-pointer */
  OPT_fopenacc = 862,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 863,                   /* -fopenacc-dim= */
  OPT_fopenmp = 864,                         /* -fopenmp */
  OPT_fopenmp_simd = 865,                    /* -fopenmp-simd */
  OPT_foperator_names = 866,                 /* -foperator-names */
  OPT_fopt_info = 867,                       /* -fopt-info */
  OPT_fopt_info_ = 868,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 869, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 870,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 871,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 872,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 873, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 874,              /* -foutput-class-dir= */
  OPT_fpack_derived = 875,                   /* -fpack-derived */
  OPT_fpack_struct = 876,                    /* -fpack-struct */
  OPT_fpack_struct_ = 877,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 878,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 879,              /* -fpcc-struct-return */
  OPT_fpch_deps = 880,                       /* -fpch-deps */
  OPT_fpch_preprocess = 881,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 882,                     /* -fpeel-loops */
  OPT_fpeephole = 883,                       /* -fpeephole */
  OPT_fpeephole2 = 884,                      /* -fpeephole2 */
  OPT_fpermissive = 885,                     /* -fpermissive */
  OPT_fpic = 886,                            /* -fpic */
  OPT_fpie = 887,                            /* -fpie */
  OPT_fplan9_extensions = 888,               /* -fplan9-extensions */
  OPT_fplt = 889,                            /* -fplt */
  OPT_fplugin_arg_ = 890,                    /* -fplugin-arg- */
  OPT_fplugin_ = 891,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 892,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 893,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 894,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 895,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 896,                   /* -fpreprocessed */
  OPT_fpretty_templates = 897,               /* -fpretty-templates */
  OPT_fprofile = 898,                        /* -fprofile */
  OPT_fprofile_arcs = 899,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 900,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 901,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 902,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 903,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 904,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 905,                 /* -fprofile-report */
  OPT_fprofile_use = 906,                    /* -fprofile-use */
  OPT_fprofile_use_ = 907,                   /* -fprofile-use= */
  OPT_fprofile_values = 908,                 /* -fprofile-values */
  OPT_fprotect_parens = 909,                 /* -fprotect-parens */
  OPT_frandom_seed = 910,                    /* -frandom-seed */
  OPT_frandom_seed_ = 911,                   /* -frandom-seed= */
  OPT_frange_check = 912,                    /* -frange-check */
  OPT_freal_4_real_10 = 913,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 914,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 915,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 916,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 917,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 918,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 919,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 920,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 921,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 922,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 923,                /* -frecord-marker=8 */
  OPT_frecursive = 924,                      /* -frecursive */
  OPT_freduced_reflection = 925,             /* -freduced-reflection */
  OPT_free = 926,                            /* -free */
  OPT_freg_struct_return = 927,              /* -freg-struct-return */
  /* OPT_fregmove = 928, */                  /* -fregmove */
  OPT_frename_registers = 929,               /* -frename-registers */
  OPT_freorder_blocks = 930,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 931,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 932,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 933,              /* -freorder-functions */
  OPT_frepack_arrays = 934,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 935,           /* -freplace-objc-classes */
  OPT_frepo = 936,                           /* -frepo */
  OPT_freport_bug = 937,                     /* -freport-bug */
  OPT_frequire_return_statement = 938,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 939,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 940, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 941,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 942,                    /* -fresolution= */
  OPT_frounding_math = 943,                  /* -frounding-math */
  OPT_frtti = 944,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 945,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 946,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 947,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 948,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 949,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 950,                      /* -fsanitize= */
  OPT_fsaw_java_file = 951,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 952,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 953,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 954,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 955,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 956,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 957,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 958,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 959,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 960,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 961,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 962,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 963,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 964,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 965,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 966,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 967,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 968,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 969, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 970,                /* -fschedule-fusion */
  OPT_fschedule_insns = 971,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 972,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 973,              /* -fsecond-underscore */
  OPT_fsection_anchors = 974,                /* -fsection-anchors */
  /* OPT_fsee = 975, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 976,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 977,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 978, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 979,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 980,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 981,         /* -fsemantic-interposition */
  OPT_fshort_enums = 982,                    /* -fshort-enums */
  OPT_fshort_wchar = 983,                    /* -fshort-wchar */
  OPT_fshow_column = 984,                    /* -fshow-column */
  OPT_fshrink_wrap = 985,                    /* -fshrink-wrap */
  OPT_fsign_zero = 986,                      /* -fsign-zero */
  OPT_fsignaling_nans = 987,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 988,               /* -fsigned-bitfields */
  OPT_fsigned_char = 989,                    /* -fsigned-char */
  OPT_fsigned_zeros = 990,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 991,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 992,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 993,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 994,               /* -fsource-filename= */
  OPT_fsource_ = 995,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 996,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 997,                    /* -fsplit-paths */
  OPT_fsplit_stack = 998,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 999,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 1000, */                /* -fsquangle */
  OPT_fssa_backprop = 1001,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1002,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1003,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1004,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1005, */             /* -fstack-check */
  OPT_fstack_check_ = 1006,                  /* -fstack-check= */
  OPT_fstack_limit = 1007,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1008,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1009,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1010,               /* -fstack-protector */
  OPT_fstack_protector_all = 1011,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1012,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1013,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1014,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1015,                   /* -fstack-usage */
  OPT_fstats = 1016,                         /* -fstats */
  OPT_fstdarg_opt = 1017,                    /* -fstdarg-opt */
  OPT_fstore_check = 1018,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1019, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1020,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1021,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1022,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1023, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1024,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1025,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1026,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1027,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1028, */             /* -ftarget-help */
  OPT_ftarget_ = 1029,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1030,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1031, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1032,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1033,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1034, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1035,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1036,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1037,                   /* -ftime-report */
  ...
  OPT_ftrapping_math = 1043,                 /* -ftrapping-math */
  OPT_ftrapv = 1044,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1045,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1046,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1047,                      /* -ftree-ccp */
  OPT_ftree_ch = 1048,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1049, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1050,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1051,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1052, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1053,                   /* -ftree-cselim */
  OPT_ftree_dce = 1054,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1055,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1056,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1057,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1058,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1059, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1060,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1061,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1062,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1063,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1064,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1065, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1066,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1067,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1068,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1069,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1070,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1071,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1072,                      /* -ftree-pre */
  OPT_ftree_pta = 1073,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1074,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1075, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1076,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1077,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1078,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1079,                     /* -ftree-slsr */
  OPT_ftree_sra = 1080,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1081, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1082, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1083,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1084,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1085,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1086, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1087,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1088, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1089,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1090,         /* -funconstrained-commons */
  OPT_funderscoring = 1091,                  /* -funderscoring */
  OPT_funit_at_a_time = 1092,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1093,              /* -funroll-all-loops */
  OPT_funroll_loops = 1094,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1095,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1096,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1097,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1098,                 /* -funsigned-char */
  OPT_funswitch_loops = 1099,                /* -funswitch-loops */
  OPT_funwind_tables = 1100,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1101,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1102,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1103,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1104,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1105,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1106,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1107,                   /* -fuse-ld=gold */
  ...
  OPT_m32 = 1182,                            /* -m32 */
  OPT_m64 = 1183,                            /* -m64 */
  OPT_mabi_altivec = 1184,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1185,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1186,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1187,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1188,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1189,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1190,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1191,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1192,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1193,                       /* -mabi=spe */
  OPT_mads = 1194,                           /* -mads */
  OPT_maix_struct_return = 1195,             /* -maix-struct-return */
  OPT_malign_ = 1196,                        /* -malign- */
  OPT_malign_branch_targets = 1197,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1198,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1199,             /* -mallow-movmisalign */
  OPT_maltivec = 1200,                       /* -maltivec */
  OPT_maltivec_be = 1201,                    /* -maltivec=be */
  OPT_maltivec_le = 1202,                    /* -maltivec=le */
  OPT_malways_hint = 1203,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1204,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1205,                           /* -mbig */
  OPT_mbig_endian = 1206,                    /* -mbig-endian */
  OPT_mbit_align = 1207,                     /* -mbit-align */
  OPT_mbit_word = 1208,                      /* -mbit-word */
  OPT_mblock_move_inline_limit_ = 1209,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1210,                       /* -mbss-plt */
  OPT_mcall_ = 1211,                         /* -mcall- */
  OPT_mcmpb = 1212,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1213,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1214,                          /* -mcpu= */
  OPT_mcrypto = 1215,                        /* -mcrypto */
  OPT_mdebug_ = 1216,                        /* -mdebug= */
  OPT_mdirect_move = 1217,                   /* -mdirect-move */
  OPT_mdlmzb = 1218,                         /* -mdlmzb */
  OPT_mdouble_float = 1219,                  /* -mdouble-float */
  OPT_meabi = 1220,                          /* -meabi */
  OPT_mefficient_unaligned_vector = 1221,    /* -mefficient-unaligned-vector */
  OPT_memb = 1222,                           /* -memb */
  OPT_mfloat_gprs_ = 1223,                   /* -mfloat-gprs= */
  OPT_mfloat128 = 1224,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1225,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1226,             /* -mfloat128-hardware */
  OPT_mfp_in_toc = 1227,                     /* -mfp-in-toc */
  OPT_mfprnd = 1228,                         /* -mfprnd */
  OPT_mfpu_ = 1229,                          /* -mfpu= */
  OPT_mfriz = 1230,                          /* -mfriz */
  OPT_mfull_toc = 1231,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1232, */              /* -mfused-madd */
  OPT_mgcbios = 1233,                        /* -mgcbios */
  OPT_mgcn = 1234,                           /* -mgcn */
  OPT_mgen_cell_microcode = 1235,            /* -mgen-cell-microcode */
  OPT_mhard_dfp = 1236,                      /* -mhard-dfp */
  OPT_mhard_float = 1237,                    /* -mhard-float */
  OPT_mhtm = 1238,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1239,            /* -minsert-sched-nops= */
  OPT_misel = 1240,                          /* -misel */
  /* OPT_misel_no = 1241, */                 /* -misel=no */
  /* OPT_misel_yes = 1242, */                /* -misel=yes */
  OPT_mlittle = 1243,                        /* -mlittle */
  OPT_mlittle_endian = 1244,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1245,                  /* -mlong-double- */
  OPT_mlongcall = 1246,                      /* -mlongcall */
  OPT_mlra = 1247,                           /* -mlra */
  OPT_mmfcrf = 1248,                         /* -mmfcrf */
  OPT_mmfpgpr = 1249,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1250,                   /* -mminimal-toc */
  OPT_mmodulo = 1251,                        /* -mmodulo */
  OPT_mmulhw = 1252,                         /* -mmulhw */
  OPT_mmultiple = 1253,                      /* -mmultiple */
  OPT_mmvme = 1254,                          /* -mmvme */
  OPT_mnewlib = 1255,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1256,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1257,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1258,                        /* -mno-toc */
  OPT_mno_traceback = 1259,                  /* -mno-traceback */
  OPT_mno_update = 1260,                     /* -mno-update */
  OPT_mogc = 1261,                           /* -mogc */
  OPT_moptimize_swaps = 1262,                /* -moptimize-swaps */
  OPT_mpaired = 1263,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1264,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1265,                       /* -mpopcntb */
  OPT_mpopcntd = 1266,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1267,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1268,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1269,                 /* -mpower8-vector */
  OPT_mpower9_dform = 1270,                  /* -mpower9-dform */
  OPT_mpower9_dform_scalar = 1271,           /* -mpower9-dform-scalar */
  OPT_mpower9_dform_vector = 1272,           /* -mpower9-dform-vector */
  OPT_mpower9_fusion = 1273,                 /* -mpower9-fusion */
  OPT_mpower9_minmax = 1274,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1275,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1276,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1277, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1278,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1279,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1280,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1281,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1282,                     /* -mprototype */
  OPT_mquad_memory = 1283,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1284,            /* -mquad-memory-atomic */
  OPT_mrecip = 1285,                         /* -mrecip */
  OPT_mrecip_precision = 1286,               /* -mrecip-precision */
  OPT_mrecip_ = 1287,                        /* -mrecip= */
  OPT_mregnames = 1288,                      /* -mregnames */
  OPT_mrelocatable = 1289,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1290,               /* -mrelocatable-lib */
  OPT_mrvl = 1291,                           /* -mrvl */
  OPT_msave_toc_indirect = 1292,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1293,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1294,                  /* -msched-epilog */
  OPT_msched_groups = 1295,                  /* -msched-groups */
  OPT_msched_prolog = 1296,                  /* -msched-prolog */
  OPT_msdata = 1297,                         /* -msdata */
  OPT_msdata_ = 1298,                        /* -msdata= */
  OPT_msecure_plt = 1299,                    /* -msecure-plt */
  OPT_mshlib = 1300,                         /* -mshlib */
  OPT_msim = 1301,                           /* -msim */
  OPT_msimple_fpu = 1302,                    /* -msimple-fpu */
  OPT_msingle_float = 1303,                  /* -msingle-float */
  OPT_msingle_pic_base = 1304,               /* -msingle-pic-base */
  OPT_msoft_float = 1305,                    /* -msoft-float */
  OPT_mspe = 1306,                           /* -mspe */
  /* OPT_mspe_no = 1307, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1308, */                 /* -mspe=yes */
  OPT_mstrict_align = 1309,                  /* -mstrict-align */
  OPT_mstring = 1310,                        /* -mstring */
  OPT_msum_in_toc = 1311,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1312,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1313,                   /* -mtls-markers */
  OPT_mtls_size_ = 1314,                     /* -mtls-size= */
  OPT_mtoc = 1315,                           /* -mtoc */
  OPT_mtoc_fusion = 1316,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1317,                    /* -mtraceback= */
  OPT_mtune_ = 1318,                         /* -mtune= */
  OPT_mupdate = 1319,                        /* -mupdate */
  OPT_mupper_regs = 1320,                    /* -mupper-regs */
  OPT_mupper_regs_df = 1321,                 /* -mupper-regs-df */
  OPT_mupper_regs_sf = 1322,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1323,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1324,            /* -mvectorize-builtins */
  OPT_mvgc = 1325,                           /* -mvgc */
  OPT_mvrsave = 1326,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1327, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1328, */              /* -mvrsave=yes */
  OPT_mvsx = 1329,                           /* -mvsx */
  OPT_mvsx_align_128 = 1330,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1331,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1332,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1333, */       /* -mvsx-scalar-memory */
  OPT_mvsx_timode = 1334,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1335,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1336,           /* -mwarn-cell-microcode */
  OPT_mwup = 1337,                           /* -mwup */
  OPT_mxilinx_fpu = 1338,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1339,                     /* -mxl-compat */
  OPT_myellowknife = 1340,                   /* -myellowknife */
  OPT_n = 1341,                              /* -n */
  OPT_no_canonical_prefixes = 1342,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1343,              /* -no-integrated-cpp */
  OPT_no_pie = 1344,                         /* -no-pie */
  OPT_nocpp = 1345,                          /* -nocpp */
  OPT_nodefaultlibs = 1346,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1347,                   /* -nostartfiles */
  OPT_nostdinc = 1348,                       /* -nostdinc */
  OPT_nostdinc__ = 1349,                     /* -nostdinc++ */
  OPT_nostdlib = 1350,                       /* -nostdlib */
  OPT_o = 1351,                              /* -o */
  OPT_p = 1352,                              /* -p */
  OPT_pass_exit_codes = 1353,                /* -pass-exit-codes */
  /* OPT_pedantic = 1354, */                 /* -pedantic */
  OPT_pedantic_errors = 1355,                /* -pedantic-errors */
  OPT_pg = 1356,                             /* -pg */
  OPT_pie = 1357,                            /* -pie */
  OPT_pipe = 1358,                           /* -pipe */
  OPT_print_file_name_ = 1359,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1360,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1361,          /* -print-multi-directory */
  OPT_print_multi_lib = 1362,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1363,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1364,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1365,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1366,               /* -print-prog-name= */
  OPT_print_search_dirs = 1367,              /* -print-search-dirs */
  OPT_print_sysroot = 1368,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1369,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1370,                          /* -quiet */
  OPT_r = 1371,                              /* -r */
  OPT_remap = 1372,                          /* -remap */
  OPT_s = 1373,                              /* -s */
  OPT_s_bc_abi = 1374,                       /* -s-bc-abi */
  OPT_save_temps = 1375,                     /* -save-temps */
  OPT_save_temps_ = 1376,                    /* -save-temps= */
  OPT_shared = 1377,                         /* -shared */
  OPT_shared_libgcc = 1378,                  /* -shared-libgcc */
  /* OPT_specs = 1379, */                    /* -specs */
  OPT_specs_ = 1380,                         /* -specs= */
  OPT_static = 1381,                         /* -static */
  OPT_static_libasan = 1382,                 /* -static-libasan */
  OPT_static_libgcc = 1383,                  /* -static-libgcc */
  OPT_static_libgcj = 1384,                  /* -static-libgcj */
  OPT_static_libgfortran = 1385,             /* -static-libgfortran */
  OPT_static_libgo = 1386,                   /* -static-libgo */
  OPT_static_liblsan = 1387,                 /* -static-liblsan */
  OPT_static_libmpx = 1388,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1389,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1390,               /* -static-libstdc++ */
  OPT_static_libtsan = 1391,                 /* -static-libtsan */
  OPT_static_libubsan = 1392,                /* -static-libubsan */
  /* OPT_std_c__03 = 1393, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1394, */                /* -std=c++0x */
  OPT_std_c__11 = 1395,                      /* -std=c++11 */
  OPT_std_c__14 = 1396,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1397, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1398, */                /* -std=c++1y */
  OPT_std_c__1z = 1399,                      /* -std=c++1z */
  OPT_std_c__98 = 1400,                      /* -std=c++98 */
  OPT_std_c11 = 1401,                        /* -std=c11 */
  /* OPT_std_c1x = 1402, */                  /* -std=c1x */
  /* OPT_std_c89 = 1403, */                  /* -std=c89 */
  OPT_std_c90 = 1404,                        /* -std=c90 */
  OPT_std_c99 = 1405,                        /* -std=c99 */
  /* OPT_std_c9x = 1406, */                  /* -std=c9x */
  OPT_std_f2003 = 1407,                      /* -std=f2003 */
  OPT_std_f2008 = 1408,                      /* -std=f2008 */
  OPT_std_f2008ts = 1409,                    /* -std=f2008ts */
  OPT_std_f95 = 1410,                        /* -std=f95 */
  OPT_std_gnu = 1411,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1412, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1413, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1414,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1415,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1416, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1417, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1418,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1419,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1420,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1421, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1422, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1423,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1424,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1425, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1426, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1427,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1428, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1429, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1430, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1431,                     /* -std=legacy */
  OPT_symbolic = 1432,                       /* -symbolic */
  OPT_t = 1433,                              /* -t */
  OPT_time = 1434,                           /* -time */
  OPT_time_ = 1435,                          /* -time= */
  OPT_traditional = 1436,                    /* -traditional */
  OPT_traditional_cpp = 1437,                /* -traditional-cpp */
  OPT_trigraphs = 1438,                      /* -trigraphs */
  OPT_u = 1439,                              /* -u */
  OPT_undef = 1440,                          /* -undef */
  OPT_v = 1441,                              /* -v */
  OPT_version = 1442,                        /* -version */
  OPT_w = 1443,                              /* -w */
  OPT_wrapper = 1444,                        /* -wrapper */
  OPT_x = 1445,                              /* -x */
  OPT_z = 1446,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
