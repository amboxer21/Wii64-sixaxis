...
#define gt_ggc_m_26hash_table_builtin_hasher_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_table_builtin_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_builtin_hasher_ (void *);
...
#define gt_ggc_m_22hash_table_toc_hasher_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_table_toc_hasher_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_table_toc_hasher_ (void *);
...
#define gt_pch_n_26hash_table_builtin_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_builtin_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_builtin_hasher_ (void *);
...
#define gt_pch_n_22hash_table_toc_hasher_(X) do { \
  if (X != NULL) gt_pch_nx_hash_table_toc_hasher_ (X);\
  } while (0)
extern void gt_pch_nx_hash_table_toc_hasher_ (void *);
...
#define gt_pch_n_18dw_ranges_by_label(X) do { \
  if (X != NULL) gt_pch_nx_dw_ranges_by_label (X);\
  } while (0)
extern void gt_pch_nx_dw_ranges_by_label (void *);
#define gt_pch_n_9dw_ranges(X) do { \
  if (X != NULL) gt_pch_nx_dw_ranges (X);\
  } while (0)
extern void gt_pch_nx_dw_ranges (void *);
...
extern void gt_pch_p_18vec_gimple__va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_26hash_table_builtin_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_19builtin_hash_struct
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_22hash_table_toc_hasher_
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_16limbo_die_struct
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_18dw_ranges_by_label
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_9dw_ranges
    (void *, void *, gt_pointer_operator, void *);
