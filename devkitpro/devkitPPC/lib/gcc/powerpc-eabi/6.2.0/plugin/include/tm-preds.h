/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../../gcc-6.2.0/gcc/config/rs6000/rs6000.md'.  */
...
extern int toc_fusion_or_p9_reg_operand (rtx, machine_mode);
extern int htm_spr_reg_operand (rtx, machine_mode);
...
extern int cc_reg_not_micro_cr0_operand (rtx, machine_mode);
...
extern int reg_or_none500mem_operand (rtx, machine_mode);
...
extern int rs6000_nonimmediate_operand (rtx, machine_mode);
...
extern int rs6000_cbranch_operator (rtx, machine_mode);
...
extern int toc_fusion_mem_raw (rtx, machine_mode);
extern int toc_fusion_mem_wrapped (rtx, machine_mode);
...
extern int fusion_addis_mem_combo_store (rtx, machine_mode);
extern int fusion_offsettable_mem_operand (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_r && c <= CONSTRAINT_wz;
}
...
{
  if (c >= CONSTRAINT_wD && c <= CONSTRAINT_W)
    return;
