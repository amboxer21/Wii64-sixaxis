...
#define HAVE_fusion_fpr_si_di_load ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_di_load ((TARGET_P9_FUSION) && (TARGET_64BIT))
#define HAVE_fusion_fpr_si_sf_load ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_sf_load ((TARGET_P9_FUSION) && (TARGET_64BIT))
#define HAVE_fusion_fpr_si_df_load ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_df_load ((TARGET_P9_FUSION) && (TARGET_64BIT))
#define HAVE_fusion_fpr_si_di_store ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_di_store ((TARGET_P9_FUSION) && (TARGET_64BIT))
#define HAVE_fusion_fpr_si_sf_store ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_sf_store ((TARGET_P9_FUSION) && (TARGET_64BIT))
#define HAVE_fusion_fpr_si_df_store ((TARGET_P9_FUSION) && (TARGET_32BIT))
#define HAVE_fusion_fpr_di_df_store ((TARGET_P9_FUSION) && (TARGET_64BIT))
...
#define HAVE_vec_perm_constv2sf (TARGET_PAIRED_FLOAT)
...
#define HAVE_reduc_smax_scal_v2sf (TARGET_PAIRED_FLOAT)
#define HAVE_reduc_smin_scal_v2sf (TARGET_PAIRED_FLOAT)
#define HAVE_reduc_plus_scal_v2sf (TARGET_PAIRED_FLOAT)
#define HAVE_movmisalignv2sf (TARGET_PAIRED_FLOAT)
#define HAVE_vcondv2sfv2sf (TARGET_PAIRED_FLOAT && flag_unsafe_math_optimizations)
...
extern rtx        gen_fusion_fpr_si_di_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_di_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_si_sf_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_sf_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_si_df_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_df_load       (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_si_di_store      (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_di_store      (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_si_sf_store      (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_sf_store      (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_si_df_store      (rtx, rtx, rtx);
extern rtx        gen_fusion_fpr_di_df_store      (rtx, rtx, rtx);
